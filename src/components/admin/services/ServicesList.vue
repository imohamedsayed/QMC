    ...
    <div class="pa-8 pb-16">
        ...
        >
            ...
            <template #item-action="item">
                <v-btn icon elevation="0" class="mr-2" @click="$router.push({ name: 'EditService', params: { id: item.id } })"
        ...
        <v-dialog v-model="dialog" width="500" transition="dialog-top-transition" persistent>
            <v-card class="pa-4" :loading="loading">
                <v-card-title>Do you really want to delete this section?</v-card-title>
                <v-card-text>After confirming the deletion of this section you cannot undo the changes you made</v-card-text>
