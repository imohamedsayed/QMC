    ...
    <div class="d-inline" v-if="user">
        <v-menu width="360">
            ...
            <v-sheet rounded="md" elevation="10" class="pa-3">
                ...
                <v-list density="default" lines="three" v-else-if="!loading && notifications.length">
                        ...
                        <div v-for="n in notifications" :key="n.id">
                            ...
                            >
                                <v-list-item-subtitle>
                                    <span>{{ n.data.message.message.substring(0, 30) + '...' }}</span>
                                    ><br />
...
const user = computed(() => authStore.getAdmin);
