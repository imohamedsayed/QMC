<template>
    <v-row>
        <v-col cols="12" md="12">
            <UiParentCard title="Add a new category" :loading="state.loading">
                <div class="pa-10">
    ...
    setup() {
        ...
        onMounted(async () => {
            ...
            try {
                ...
                if (res.status == 200) {
                    state.parentCategories = res.data.data;
                } else {
        ...
        const add = async () => {
            ...
            if (!v$.value.$error) {
                ...
                try {
                    ...
                    const res = await axios.post('api_dashboard/categories', data, {
                        headers: {
