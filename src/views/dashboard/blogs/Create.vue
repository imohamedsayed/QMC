<template>
    <v-row>
        <v-col cols="12" md="12">
            <UiParentCard title="Add a Blog" :loading="state.loading">
                <div class="pa-10">
...
import TipTab from '@/components/admin/tiptap/TibTap.vue';
export default {
    ...
    setup() {
        ...
        const add = async () => {
            ...
            if (!v$.value.$error) {
                ...
                try {
                    ...
                    const res = await axios.post('api_dashboard/blogs', data, {
                        headers: {
        ...
        return { state, getImageUrl, v$, add, init };
    }
};
</script>
